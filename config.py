...
├📕 Lɪʙʀᴀʀy : <a href=https://github.com/KMSRename>CLICK HERE</a>
...
◦ <code> -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @kmsmovies1" -metadata author="@kmsmovies1" -metadata:s:s title="Subtitled By :- @kmsmovies1" -metadata:s:a title="By :- @kmsmovies1" -metadata:s:v title="By:- @kmsmovies1" </code>
...
<a href=https://t.me/kmsmovies1>KMS ᴘʀᴏᴅᴜᴄᴛɪᴏɴꜱ</a>
</b>"""
